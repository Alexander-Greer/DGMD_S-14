...
def convert_ST_data(input_split_list, orientation_output):
    ...
    return([timestamp] + orientation_output)
...
writefilepath = 'loggedfile.txt'
write_file = open(writefilepath, 'a')
...
while True:
    ...
    if split_line[0] == "Received":
        converted_data = convert_ST_data(split_line, orientation_variables)
        print(converted_data)
        write_file.write(str(converted_data) + '\n')
